      ...
      <div class="modal-body pt-2">
        ...
        <form method="post" action="login.php" class="login-form" autocomplete="off">
          <div class="mb-3"><label class="form-label">อีเมล</label>
            <input type="email" name="email" class="form-control" required autocomplete="new-email"></div>
      ...
      <div class="modal-body pt-0">
        <form method="post" action="register.php" class="register-form" autocomplete="off">
          <div class="mb-3"><label class="form-label">ชื่อผู้ใช้</label>
            <input type="text" name="username" class="form-control rounded-3" required></div>
          <div class="mb-3"><label class="form-label">อีเมล</label>
            <input type="email" name="email" class="form-control rounded-3" required></div>
          <div class="mb-3"><label class="form-label">รหัสผ่าน</label>
            <input type="password" name="password" class="form-control rounded-3" required></div>
          <div class="mb-3"><label class="form-label">ยืนยันรหัสผ่าน</label>
            <input type="password" name="confirm_password" class="form-control rounded-3" required></div>
      ...
      <div class="modal-body pt-2">
        <form id="uploadForm" method="post" action="uploads.php" enctype="multipart/form-data" class="upload-form">
          ...
          <div class="row g-3 mb-3">
            <div class="col-md-6">
              <label class="form-label">ไฟล์โมเดล (.obj/.glb/.gltf)</label>
          ...
          <div class="row g-3 mb-3">
            <div class="col-md-4">
              <label class="form-label text-success fw-bold"><i class="bi bi-tag-fill"></i> ตั้งราคา (บาท)</label>
              <input type="number" step="0.01" min="0" name="price" class="form-control border-success" placeholder="0.00 (ฟรี)">
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
              <label class="form-label">Tags <small class="text-muted">(คั่นด้วยจุลภาค)</small></label>
              <input name="tags" class="form-control" placeholder="เช่น vehicle, sci-fi">
            </div>
          </div>
        </form>
      </div>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-header"><h5 class="modal-title">แก้ไขโมเดล</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
        ...
        <div class="row g-3 mb-3">
          <div class="col-md-6"><label class="form-label">อัปเดตไฟล์โมเดล <small class="text-muted">(ไม่บังคับ)</small></label><input type="file" name="model" class="form-control" accept=".obj,.glb,.gltf"></div>
          <div class="col-md-6"><label class="form-label">อัปเดต Thumbnail <small class="text-muted">(ไม่บังคับ)</small></label><input type="file" name="thumb" class="form-control" accept=".jpg,.jpeg,.png"></div>
        </div>
        
        <div class="mb-3"><label class="form-label">คำอธิบาย</label><textarea name="description" id="edit_description" rows="2" class="form-control"></textarea></div>
        ...
        <div class="row g-3 mb-3">
          ...
          <div class="col-md-4">
            <label class="form-label">Tags <small class="text-muted">(คั่นด้วยลูกน้ำ)</small></label>
    ...
    <div class="modal-content" style="border-radius:12px; overflow:hidden;">
      ...
      <div class="modal-body text-center pt-3 pb-4">
        ...
        <form id="paymentForm" class="text-start px-3">
          ...
          <div class="mb-3">
            <label class="form-label small fw-bold text-dark">แนบสลิปโอนเงิน (เฉพาะสลิป)</label>
