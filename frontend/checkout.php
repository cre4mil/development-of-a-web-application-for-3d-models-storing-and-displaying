    ...
    <div class="checkout-grid">
      ...
      <div>
        <div class="card-panel">
          ...
          <div class="qr-wrap">
            <div id="qrCanvas" aria-label="PromptPay QR code"></div>
          ...
          <div class="slip-drop-zone" id="slipDropZone">
            <label class="visually-hidden" for="slipInput">เลือกไฟล์สลิปการโอนเงิน</label>
...
function renderQR(amount) {
  ...
  new QRCode(container, { text: payload, width: 200, height: 200, colorDark: '#000000', colorLight: '#ffffff' });
}
